  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-7">
        <label>
          Correo electrónico:
          <input type="email" name="email" className="ml-3 border border-gray-300 p-2 rounded" />
        </label>
        <label>
          Contraseña:
          <input type="password" name="password" className="ml-3 border border-gray-300 p-2 rounded" />
        </label>
